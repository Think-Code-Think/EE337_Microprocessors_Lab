...
code unsigned char display_msg1[]= "RES2:";
code unsigned char display_msg2[]= "TIME2:";
code unsigned char display_msg3[]="us   ";


long unsigned int x=9653;
long unsigned int y=43801;  
...
void main(void)
{
	...
	for(i=0;i<9;i++)
	{
		res[8-i]=(z%10) + 48;							//Storing the result in array
		z = z/10;                 
	}
